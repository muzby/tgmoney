...
from aiotdlib import __version__
...
from aiotdlib.client_cache import ClientCache
from aiotdlib.filters import Filters
from aiotdlib.handlers import (
    FilterCallable,
    Handler,
    HandlerCallable,
)
from aiotdlib.middlewares import MiddlewareCallable
from aiotdlib.tdjson import (
    TDJson,
    TDLIB_MAX_INT,
    TDLibLogVerbosity,
)
        ...
        while not self.__is_authorized:
            ...
            while True:
                try:
                    ...
                    if 'Wrong proxy secret' in e.message:
                        raise e
